...
@section('right')
    ...
    <div class="actions mb-xl">
        ...
        <div class="icon-list text-link">
            @php $isLeader = (auth()->id() === $chapter->book->owned_by) || auth()->user()->hasSystemRole('admin'); @endphp
            ...
            {{-- Sửa nội dung (Nhân viên được phép sửa bài họ viết hoặc bài chung) --}}
            ...
            {{-- Move/Copy/Delete/Permissions (CHỈ LEADER) --}}
            @if($isLeader)
